...
# State migration: castai_agent became conditional (umbrella_enabled)
moved {
...
# State migration: castai_evictor_ext became conditional (umbrella_enabled)
moved {
...
# State migration: castai_spot_handler became conditional (umbrella_enabled)
moved {
...
resource "helm_release" "castai_kvisor" {
  count = var.install_security_agent && local.install_standalone_charts && !var.self_managed ? 1 : 0
...
resource "helm_release" "castai_workload_autoscaler" {
  count = var.install_workload_autoscaler && local.install_standalone_charts && !var.self_managed ? 1 : 0
...
resource "helm_release" "castai_workload_autoscaler_exporter" {
  count = var.install_workload_autoscaler_exporter && local.install_standalone_charts && !var.self_managed ? 1 : 0
...
resource "helm_release" "castai_pod_mutator" {
  count = var.install_pod_mutator && local.install_standalone_charts && !var.self_managed ? 1 : 0
...
resource "helm_release" "castai_ai_optimizer_proxy" {
  count = var.install_ai_optimizer && local.install_standalone_charts && !var.self_managed ? 1 : 0
...
resource "helm_release" "castai_live" {
  count = var.install_live && local.install_standalone_charts ? 1 : 0
